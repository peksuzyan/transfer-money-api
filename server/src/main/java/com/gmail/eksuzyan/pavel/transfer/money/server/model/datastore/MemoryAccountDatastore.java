package com.gmail.eksuzyan.pavel.transfer.money.server.model.datastore;
 ...
 *         Created: 10/17/2018.
 */
public class MemoryAccountDatastore implements AccountDatastore {
     ...
     */
    @Inject
    public MemoryAccountDatastore(@Named("storage") ConcurrentMap<String, Account> userAccounts) {
